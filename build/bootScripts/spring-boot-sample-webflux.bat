...
set JARPATH=%APP_HOME%\lib\spring-boot-sample-webflux-0.0.1-SNAPSHOT.jar

@rem Execute spring-boot-sample-webflux
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SPRING_BOOT_SAMPLE_WEBFLUX_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
